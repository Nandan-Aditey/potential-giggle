document.addEventListener('DOMContentLoaded', function () {
    ...
    const navStructure = [
        ...
        { id: 'problems', title: 'Identified Problems in GenBank', children: [
            { id: 'search-lottery', title: 'Search Lottery' },
            { id: 'missing-explanations', title: 'Missing Explanations' },
            { id: 'blast-blind-spots', title: 'BLAST\'s Blind Spots' },
            { id: 'inflexible-comparison', title: 'Inflexible Genome Comparison' },
            { id: 'intra-file-search', title: 'No Intelligent Intra-File Search' },
            { id: 'visualization-limitations', title: 'Visualization Limitations' },
        ]},
        { id: 'system-architecture', title: 'System Architecture'},
        { id: 'creation-timeline', title: 'Creation Timeline', children: [
            { id: 'phase-1', title: 'Phase 1: Ideation' },
            { id: 'phase-2', title: 'Phase 2: Prototyping' },
            { id: 'phase-3', title: 'Phase 3: Finalising' },
        ]},
        { id: 'key-features', title: 'Key Features', children: [
            { id: 'smart-search', title: 'Smart Search' },
            { id: 'plasmid-visualization', title: 'Plasmid Visualization' }
        ]},
        { id: 'results-impact', title: 'Results & Impact', children: [
            { id: 'usability-improvements', title: 'Usability Improvements' },
            { id: 'educational-impact', title: 'Educational Impact' },
        ]},
