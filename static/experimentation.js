document.addEventListener('DOMContentLoaded', function () {
    ...
    const navStructure = [
        { id: 'bacterial-transformation', title: 'Bacterial Transformation', children: [
            { id: 'stock-preparation', title: 'Stock Preparation' },
            { id: 'plasmid-isolation', title: 'Plasmid Isolation' },
            { id: 'restriction-digestion', title: 'Restriction enzyme digestion' },
            { id: 'elution', title: 'Elution'},
            { id: 'ligation', title: 'Ligation and Transformation' }
        ]},
        { id: 'optimal-growth', title: 'Optimal Growth Media', children: [
            { id: 'media', title: 'Media Components' },
            { id: 'compositions-table', title: 'Compositions Table' },
            { id: 'minimal-table', title: 'Minimal Media Table' },
        ]},
        { id: 'results', title: 'Results'},
        { id: 'Nitrite_met', title: 'Nitrite Metabolism in P.putida', children: [
            { id: 'ammmoqua', title: 'Ammonium Quantification' },
        ] },
        { id: 'envfac', title: 'Effect of environmental factors'}
    ];
